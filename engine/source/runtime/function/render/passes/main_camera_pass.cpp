...
namespace Piccolo
{
    ...
    void MainCameraPass::setupRenderPass()
    {
        ...
        RHIAttachmentReference vignette_input_attachment_reference {};
        if (m_enable_fxaa)
        {
            vignette_input_attachment_reference.attachment =
                &post_process_odd_color_attachment_description - attachments;
        }
        else
        {
            vignette_input_attachment_reference.attachment = &backup_odd_color_attachment_description - attachments;
        }
        vignette_input_attachment_reference.layout = RHI_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;

        RHIAttachmentReference vignette_color_attachment_reference {};
        vignette_color_attachment_reference.attachment = &backup_even_color_attachment_description - attachments;
        vignette_color_attachment_reference.layout     = RHI_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL;
        ...
        vignette_pass.pInputAttachments       = &vignette_input_attachment_reference;
        vignette_pass.colorAttachmentCount    = 1;
        vignette_pass.pColorAttachments         = &vignette_color_attachment_reference;
        ...
        vignette_pass_depend_on_color_grading_pass.srcStageMask    = VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT;
        vignette_pass_depend_on_color_grading_pass.dstStageMask    = VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
        vignette_pass_depend_on_color_grading_pass.srcAccessMask   = VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT;
        vignette_pass_depend_on_color_grading_pass.dstAccessMask   = VK_ACCESS_SHADER_READ_BIT;
